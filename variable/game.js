...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image("bg", "./image/seamless-brick-wall-game-texture-free-thumb37.jpg");
        this.load.image("door", "./image/medieval-wooden-door-with-stone-arch_1308-179709-removebg-preview.png");
        this.load.image("obstacle", "./image/rock.png");
        this.load.image("paper", "./image/paperrrr-removebg-preview.png");
        this.load.image("door-open", "./image/door-removebg-preview.png");
    ...
    createPlayer() {
        this.player = this.physics.add.sprite(305, 213, "door")
